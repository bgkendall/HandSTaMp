...
| S1, S2    | *None*     | 2 × MX-compatible switches  | MX plate3³| Keys for row 0, columns 0/1; mountings for PCB |
...
##### Notes
 ...
 2. When driving LEDs, pin PB0 must be set to [open drain mode][qmk-open-drain].
 3. Three-pin “plate-mount” switches can be used as-is. To use five-pin “PCB-mount” switches,
    the two extra plastic alignment “pins” must be removed.

[qmk-open-drain]: https://docs.qmk.fm/drivers/ws2812#open-drain-circuit
